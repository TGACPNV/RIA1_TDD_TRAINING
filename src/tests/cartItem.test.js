...
let CartItem = require('../CartItem.js').CartItem;

const InvalidArticleIdException = require("../CartItem.js").InvalidArticleIdException;
const InvalidQuantityException = require("../CartItem.js").InvalidQuantityException;
const InvalidPriceException = require("../CartItem.js").InvalidPriceException;
